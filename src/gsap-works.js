...
function goToPage(url) {
  gsap.to('.transition', { duration: 1, scaleY: 0, transformOrigin: 'bottom', ease: 'power4.inOut', onComplete: () => { window.location.href = url; }
  });
}
...
function goToPageWithState(url) {
  gsap.to('.transition', { duration: 1, scaleY: 0, transformOrigin: 'bottom', ease: 'power4.inOut', onComplete: () => {
